RSpec.describe Peatio::stemycoin::Wallet do
  let(:wallet) { Peatio::stemycoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::stemycoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::stemycoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
